...
5.7默认未开启 `performance-schema` 全部功能，参考：[performance-schema-quick-start](https://dev.mysql.com/doc/refman/5.7/en/performance-schema-quick-start.html)、[metadata-locks-table](https://dev.mysql.com/doc/refman/5.7/en/metadata-locks-table.html)
